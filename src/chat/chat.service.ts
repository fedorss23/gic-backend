...
export class ChatService {
    ...
    async createOrGetDialog(params: { userId: string; targetUserId: string }) {
        ...
        const { user1Id, user2Id } = this.normalizeUserIds(userId, targetUserId)
    ...
    async getUserDialogs(params: { userId: string; limit: number }) {
    ...
    async getMessages(params: { chatId: string; userId: string; page: number; limit: number }) {
    ...
    async sendMessage(params: { chatId: string; senderId: string; text: string }) {
